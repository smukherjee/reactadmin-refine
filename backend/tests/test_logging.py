...
from backend.app.core.logging import (
    ...
    log_auth_event, log_permission_check, log_database_operation,
    log_cache_operation, generate_request_id, set_request_context
)
import logging
...
def test_auth_event_logging():
    ...
    log_auth_event('login', 'user@example.com', success=True, details={'ip': '127.0.0.1'})
    
    # Test failed login
    log_auth_event('login', 'user@example.com', success=False, details={'reason': 'invalid_password'})
