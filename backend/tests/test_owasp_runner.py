...
def test_run_owasp_checks_smoke(start_fastapi_server):
    ...
    assert OWASPSecurityTester is not None, "OWASPSecurityTester not found in OWASPCheck.py"
...
def test_check_advanced_tools_availability():
    ...
    assert func is not None, "check_advanced_dependencies not found in test_advanced_security.py"
    status = func()
