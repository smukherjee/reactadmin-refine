...
from backend.app.repositories import get_user_repository, AsyncUserRepository
...
async def async_assign_role(
    ...
    assigned_by: Optional[str] = Query(None, description="ID of user making the assignment"),
    db: AsyncSession = Depends(get_async_db),
):
