    ...
    async def create(self, tenant_data: TenantCreate) -> Tenant:
        ...
        try:
            ...
            if tenant_data.domain:
                ...
                if existing:
                    logger.info(f"Tenant with domain {tenant_data.domain} already exists, returning existing")
                    return existing
            ...
            logger.warning(f"Integrity error creating tenant, checking for existing: {e}")
